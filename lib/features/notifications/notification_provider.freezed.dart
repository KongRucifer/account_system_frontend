...
mixin _$NotificationState {
  ...
  bool get isWebSocketConnected => throw _privateConstructorUsedError;
...
class _$NotificationStateCopyWithImpl<$Res, $Val extends NotificationState>
  ...
  $Res call({
    ...
    Object? isWebSocketConnected = null,
      ...
      _value.copyWith(
            ...
            isLoading: null == isLoading
                ...
                : isLoading // ignore: cast_nullable_to_non_nullable
                      as bool,
            isWebSocketConnected: null == isWebSocketConnected
                ? _value.isWebSocketConnected
                : isWebSocketConnected // ignore: cast_nullable_to_non_nullable
                      as bool,
            error: freezed == error
                ? _value.error
...
class _$NotificationStateImpl
  ...
  const _$NotificationStateImpl({
    final List<MeetingNotification> notifications = const [],
    this.unreadCount = 0,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'NotificationState(notifications: $notifications, unreadCount: $unreadCount, isLoading: $isLoading, isWebSocketConnected: $isWebSocketConnected, error: $error, pagination: $pagination, currentPage: $currentPage)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('isWebSocketConnected', isWebSocketConnected))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isWebSocketConnected, isWebSocketConnected) ||
